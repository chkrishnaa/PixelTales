...
export const COMMUNITY_MESSAGES = [
  {
    ...
    userId: "u1",
    userName: "AnimeFan42",
    text: "Hey everyone! Anyone watching Doraemon movies this weekend? 🎬",
    timestamp: _ts(120),
  },
  {
    id: "c2",
    ...
    text: "Yes! I just finished the parallel universe one. Absolutely mind-blowing 🤯",
    timestamp: _ts(112),
  },
  {
    id: "c3",
    userId: "u9",
    userName: "DoraFanatic",
    text: "Stand By Me Doraemon 2 made me cry like a baby 😢",
    timestamp: _ts(104),
  },
  {
    id: "c4",
    userId: "u3",
    userName: "PikachuFan",
    text: "Mewtwo Strikes Back Evolution is a visual masterpiece 🎨",
    timestamp: _ts(96),
  },
  {
    id: "c5",
    ...
    text: "The original 1998 pokemon movie hits harder though, nostalgia pain 😭",
    timestamp: _ts(90),
  },
  {
    id: "c6",
    userId: "u4",
    userName: "NinjaWatcher",
    text: "Naruto > everything, fight me 😤",
    timestamp: _ts(84),
  },
  {
    id: "c7",
    userId: "u1",
    userName: "AnimeFan42",
    text: "Lmao Naruto is great but Doraemon hits different when you grew up with it 😭",
    timestamp: _ts(78),
  },
  {
    id: "c8",
    userId: "u5",
    userName: "ShinchanFan",
    text: "Shinchan movies have the best emotional endings ngl",
    timestamp: _ts(72),
  },
  {
    id: "c9",
    userId: "u2",
    userName: "CartoonLover",
    text: 'Hard agree. The Shinchan "Adult Empire" movie is a masterpiece 👏',
    timestamp: _ts(66),
  },
  {
    id: "c10",
    userId: "u15",
    userName: "CrazyNohara",
    text: "Adult Empire is phenomenal but The Storm Called: Operation Golden Spy slaps too",
    timestamp: _ts(60),
  },
  {
    id: "c11",
    userId: "u6",
    userName: "OtakuKing",
    text: "PixelTales is literally the best site for these movies, no ads!",
    timestamp: _ts(54),
  },
  {
    id: "c12",
    ...
    text: "Tom & Jerry never gets old. Watched it today again 😂",
    timestamp: _ts(48),
  },
  {
    id: "c13",
    userId: "u17",
    userName: "ClassicToons",
    text: "That piano episode where they play together is cinema 🎹",
    timestamp: _ts(42),
  },
  {
    id: "c14",
    userId: "u20",
    userName: "HinataFan99",
    text: "The Last: Naruto the Movie made me cry so hard 😭 Naruhina forever",
    timestamp: _ts(36),
  },
  {
    id: "c15",
    userId: "u3",
    userName: "PikachuFan",
    text: "Real! I use PixelTales every weekend with my little sister 🥰",
    timestamp: _ts(30),
  },
  {
    id: "c16",
    userId: "u5",
    userName: "ShinchanFan",
    text: "Who else here grew up watching all of these? Drop a 🙋",
    timestamp: _ts(20),
  },
  {
    id: "c17",
  ...
  },
  {
    ...
    userId: "u6",
    userName: "OtakuKing",
    text: "🙋 Always! PixelTales + Naruto movies = perfect Sunday 🙌",
    timestamp: _ts(8),
  },
  {
    id: "c19",
    userId: "u4",
    userName: "NinjaWatcher",
    text: "Believe it! 🍥 This community is amazing",
    timestamp: _ts(4),
  },
  {
    id: "c20",
    userId: "u8",
    userName: "PixelFan",
    text: "Just joined PixelTales today, this platform is amazing 🔥",
    timestamp: _ts(1),
  },
];

    ...
    <footer className="mt-auto border-t border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
      <div className="page-container grid gap-8 py-10 md:grid-cols-4">
        <div className="md:col-span-1">
          <Link to="/" className="font-display text-2xl text-turquoise-600">
            Pixel<span className="text-accent-warm">Toon</span>
          </Link>
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            Your magical pocket for cartoons. Stream Doraemon, Pokemon, Shinchan
            and more.
          </p>
        </div>
